...
- Apple Shortcuts (free, but you know the caveat)
- [Locally AI](https://locallyai.app) (free, close-sourced)
- [Expenses](https://expenses.cash) (free with limitations, close-sourced)
...
this old-school way instead of keeping up with the latest trends (agents, loops,
MCP I am talking about).
