...
也叫dummy plugs。它们假装自己是一个显示器，所以系统会从GPU渲染，而不是CPU模拟，比如`xserver-xorg-video-dummy`
</HelperCard>
...
注意到`Configuration UI available at [https://localhost:47990]`。这其实是个谎言。Sunshine的Web UI监听在`0.0.0.0:47990`，我的NAS主机名是zhufusarch，所以我可以在我的笔记本访问https://zhufusarch.local:47990
...
[Desktop environment - ArchWiki](https://wiki.archlinux.org/title/Desktop_environment) 里，找到你DE的词条，里面应该会有它配置initx的方法。
</HelperCard>
...
Sunflower用最顶尖的编程技术，让Sunshine变得强健。它的做法是，
检测到Sunshine工作不正常，叫它重启。
