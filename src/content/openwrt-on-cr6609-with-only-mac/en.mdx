...
- Your ROM. If you're unsure, [here](https://openwrt.org/toh/hwdata/xiaomi/xiaomi_mi_router_cr6609) are some links.
...
If successful, it will show something like this (not exactly, but at least with `"code": 0`):
