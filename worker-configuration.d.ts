/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f848b9cd1e1a1372ab15319cab269ff1)
// Runtime types generated with workerd@1.20260310.1 2025-12-28 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		SESSION: KVNamespace;
		SESSION_ID_BY_FINGERPRINT: KVNamespace;
		FINGERPRINT_BY_IP: KVNamespace;
		ASSETS: Fetcher;
		PUBLIC_SITE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_SITE" | "PUBLIC_CLOUDINARY_CLOUD_NAME" | "POST_AUTH_KEY" | "DB_URL" | "CLOUDINARY_UPLOAD_PRESET">> {}
}
